...
WB LSMS data - unzip to data/input/LSMS - http://econ.worldbank.org/WBSITE/EXTERNAL/EXTDEC/EXTRESEARCH/EXTLSMS/0,,contentMDK:23512006~pagePK:64168445~piPK:64168309~theSitePK:3358997,00.html

DHS data - unzip to data/input/DHS - http://dhsprogram.com/data/dataset_admin/download-datasets.cfm

(Download GDAL)

2. Download Trained CNN Model

https://www.dropbox.com/s/4cmfgay9gm2fyj6/predicting_poverty_trained.caffemodel?dl=0

3. Download nightlights data
...
6. Identify existing survey cluster download locations
...
7. Generate Kaduna Grid for sampled points
...
8. Download daytime image locations
...
9. Save lats-lons numpy for new points
...
12. Scale and Organize Analysis Data
